...
The assignment is designed to practice the different clustering algorithms we used. We reanalyzed the dataset about economic indicators of several countries. 
```{r}
# data loading
...
4. Which linkage method did you use? Now, compare the results fixing one of the distance, and use the different linkage methods you know. 
...
8. BONUS: check the stability of the chosen solutions using the bootstrap and comment the output. 
